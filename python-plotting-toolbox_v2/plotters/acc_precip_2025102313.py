...
def plot_accum(lats, lons, rain, start_t, end_t, outdir, hours, cities, latS, latN, lonW, lonE):
    ...
    # Custom colormap with white for 0 mm using the provided levels
    clevs = [0.0, 1.0, 5.0, 10.0, 15.0, 20.0, 30.0, 40.0, 50.0, 70.0, 100.0,
    ...
    cs = ax.contourf(lons, lats, rain, levels=clevs, cmap=cmap, norm=norm, transform=ccrs.PlateCarree(), extend='max')
