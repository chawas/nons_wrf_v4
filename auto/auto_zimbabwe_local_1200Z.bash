...
### CLEAN OLD LOG FILES
####################################################
find /home/wrf/nons_wrf_v4/gfs-retrieval/logs/ -name "*.log" -type f -mtime +1 -delete
echo "Old log files cleaned."

####################################################
### DATE VARIABLES
####################################################
DATEGRIB="$(date +"%y%m%d1200")"
...
# Download GFS data
python3 retrieve_gfs_data_1200Z.py || { echo "Error: Failed to retrieve GFS data"; exit 1; }
